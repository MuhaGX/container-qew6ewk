...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qew6ewk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qew6ewk.containers.anotherwebservice.com/
...
```
git clone git@github.com:MuhaGX/container-qew6ewk.git
cd container-qew6ewk
```
...
```
docker attach container-qew6ewk
```
